...
export default function SourceList({}) {
  return (
    <section
      className={`min-w-[340px] flex _flex-wrap md:flex-wrap lg:flex-nowrap justify-center p-2 m-2 md:px-1 lg:px-2 gap-4 lg:mx-0 xl:gap-6`}
    >
      {pubArray.map((source) => {
  ...
  return (
    ...
    >
      <img
        ...
        className={``}
      />
      <p className={`hidden ${`md:inline capitalize font-medium`}`}>
        {source.title}
      </p>
    </button>
  );
